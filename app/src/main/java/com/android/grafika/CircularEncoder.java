...
public class CircularEncoder {
    ...
    private static class EncoderThread extends Thread {
         ...
         */
        // added by crankyblack to account FPS in Encoder
        long frameCount = 0;
            ...
            while (true) {
                ...
                if (encoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                    ...
                    if (mBufferInfo.size != 0) {
                        ...
                        if (prevPresentationTimeUs == 0) {
                            currentPresentationTimeUs = 0;
                        } else {
                            currentPresentationTimeUs =
                                    mBufferInfo.presentationTimeUs - prevPresentationTimeUs;
                        }
                        prevPresentationTimeUs = mBufferInfo.presentationTimeUs;

                        Log.d(TAG, "    Encoded Frame: " + frameCount + " " + mBufferInfo.size + " bytes " + currentPresentationTimeUs + " us");
        ...
        void saveVideo(File outputFile) {
            ...
            this.copyFile(outputFile, "/sdcard/continuous-copied.mp4");
